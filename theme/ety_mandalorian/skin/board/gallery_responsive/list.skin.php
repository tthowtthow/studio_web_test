									...
									<?php for ($i=0; $i<count($list); $i++) {
									 ...
									 ?>
										<div class="col-xs-12 col-sm-6 <?php echo $cols;?> card-position">
											...
											<div class="gall_chk">
											<?php if ($is_checkbox) { ?>
											<label for="chk_wr_id_<?php echo $i ?>" class="sound_only"><?php echo cut_str($list[$i]['subject'],$board['bo_subject_len']) ?></label>
												...
												<div class="card-content">
													<h4 class="card-title">
														...
														<a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
															<span class="ks4" style="font-size:16px;"><?php echo cut_str($list[$i]['subject'],$board['bo_subject_len']) ?></span>
