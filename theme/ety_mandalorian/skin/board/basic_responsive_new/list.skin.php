				...
				<div class="col-lg-12">
					...
					<div class="menu">
						<select name="" class="select-menu" onchange="location.href=this.value">
							...
							<option value="<?php echo G5_URL?>/board01" selected>일반게시판</option>
							<option value="<?php echo G5_BBS_URL?>/faq.php">FAQ</option>
						</select>
					</div>
		...
		<table class="table table-bordered">
		  <thead>
			<tr>
				...
				<th>제목</th>
				<th>글쓴이</th>
				<th><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 <i class="fa fa-sort" aria-hidden="true"></i></a></th>
				<?php if ($is_good) { ?><th><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천 <i class="fa fa-sort" aria-hidden="true"></i></a></th><?php } ?>
				<?php if ($is_nogood) { ?><th><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 <i class="fa fa-sort" aria-hidden="true"></i></a></th><?php } ?>
				<th><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜  <i class="fa fa-sort" aria-hidden="true"></i></a></th>
			</tr>
		  </thead>
		  <tbody>
			<?php
			...
			<tr <?php if ($list[$i]['is_notice']) echo $not; ?>>
				...
				<td class="text-center"><span class="profile_img"><?php echo get_member_profile_img($list[$i]['mb_id']);?></span> <?php echo $list[$i]['name'] ?></td>
				<td class="text-center"><?php echo $list[$i]['wr_hit'] ?></td>
				...
				<td class="text-center"><?php echo $list[$i]['datetime2'] ?></td>
			</tr>
			<?php } ?>
