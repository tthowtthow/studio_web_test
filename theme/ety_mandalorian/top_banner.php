...
$season_1 =			G5_URL.'/pages/img/3.jpg';
$season_2 =			G5_URL.'/pages/img/3.jpg';
$season_3 =			G5_URL.'/pages/img/3.jpg';
...
// 일반게시판
if($bo_table == 'season_1'){
	$background_images = $season_1;
}
if($bo_table == 'season_2'){
	$background_images = $season_2;
}
if($bo_table == 'season_3'){
	$background_images = $season_3;
}
