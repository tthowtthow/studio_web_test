...
<div class="container mt-3">
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <!--Hard Coding  -->
      <a class="nav-link notice" href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=free">Notice</a>
    </li>
    <li class="nav-item">
      <a class="nav-link qa" href="<?php echo G5_BBS_URL; ?>/qalist.php">QnA</a>
    </li>
  </ul>
</div>


<div class="qa_entire_div">
  <div class="container" id="qa_whole_div">
     <!-- 게시판 페이지 정보 및 버튼 시작 { -->
    <div id="bo_btn_top">
