...
<p class="text-center h1 mt-2 mb-2">Blog & Youtube</p>


<div class="container mt-3">
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link notice" href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=<?php echo $bo_table; ?>">Blog</a>
    </li>
    <li class="nav-item">
      <a class="nav-link qa" href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=youtube">Youtube</a>
    </li>
  </ul>
</div>
...
<!-- 게시판 목록 시작 { -->
<div class="container" id="bo_gall" >
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="">
            <div class="">
                ...
                <input type="checkbox" name="chk_wr_id[]" class="float-right" value="<?php echo $list[$i]['wr_id'] ?>"
                ...
                <div class="container mx-auto text-center mt-5 mb-5">
                        ...
                        <?php } else {
                            $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], 365, 400, false, true);
                            if($thumb['src']) {
                    ...
                    <p class="h3">
                        ...
                        if ($is_category && $list[$i]['ca_name']) {
                         ?>
                        <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link" style="text-decoration:none;">
                          <?php echo $list[$i]['ca_name'] ?>
                        </a>
                        <?php } ?>
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit" style="text-decoration:none;">
                            <p class="h1"><?php echo $list[$i]['subject'] ?></p>
                            <?php if ($list[$i]['comment_cnt']) { ?>
                              <span class="sound_only">댓글</span><span class="cnt_cmt">+ <?php echo $list[$i]['wr_comment']; ?>
                            </span><span class="sound_only">개</span><?php } ?>
                         </a>
                    </p>


                      <p>
                        <span class="sound_only">작성자 </span>   <strong><?php echo $list[$i]['name'] ?></strong> &nbsp;&nbsp;
                    ...
                    <p  class="mt-4 mb-4 h4"> <?php echo ($list[$i]['wr_content']);  ?></p>
