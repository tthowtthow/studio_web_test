...
<div class="" id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h1 id="bo_v_title">
            <?php
    ...
    <?php
      ...
      <br>
			<?php echo
				'<iframe style="width:100%;height:480px;" frameborder="0" src="'.$link[0].'" class="video-frame stopWhenVideoModal"></iframe>'
			?>
        ...
        <div id="bo_v_act">
            ...
            <span class="bo_v_act_gng">
                <a href="<?php echo $good_href.'&amp;'.$qstr ?>" id="good_button" class="btn_b01 btn">추천 <strong><?php echo number_format($view['wr_good']) ?></strong></a>
                <b id="bo_v_act_good"></b>
            </span>
            <?php } ?>
            <?php if ($nogood_href) { ?>
            <span class="bo_v_act_gng">
                <a href="<?php echo $nogood_href.'&amp;'.$qstr ?>" id="nogood_button" class="btn_b01 btn">비추천  <strong><?php echo number_format($view['wr_nogood']) ?></strong></a>
    ...
    <div id="bo_v_bot">
      ...
      <ul class="bo_v_nb">
          <?php if ($prev_href) { ?><li><a href="<?php echo $prev_href ?>" class="btn_b01 btn"><i class="fa fa-caret-up" aria-hidden="true"></i>이전글</a></li><?php } ?>
          <?php if ($next_href) { ?><li><a href="<?php echo $next_href ?>" class="btn_b01 btn"><i class="fa fa-caret-down" aria-hidden="true"></i>다음글</a></li><?php } ?>
      </ul>
      <?php } ?>

      <ul class="bo_v_com">

          <?php if ($scrap_href) { ?><a href="<?php echo $scrap_href;  ?>" target="_blank" class="btn_b01 btn" onclick="win_scrap(this.href); return false;">스크랩</a><?php } ?>
